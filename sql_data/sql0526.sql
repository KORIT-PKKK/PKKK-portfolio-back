...
INSERT INTO `location_eval` VALUES (1,24,1),(2,26,13),(3,26,16),(4,1,17),(5,1,18),(6,38,19),(7,183,20);
...
INSERT INTO `location_pic` VALUES (1,26,16,8),(2,1,17,9),(3,1,17,10),(4,1,17,11),(5,1,17,12),(6,1,18,13),(7,1,18,14),(8,38,19,15),(9,38,19,16),(10,38,19,17);
...
INSERT INTO `location_post` VALUES (1,24,1),(13,26,13),(16,26,16),(17,1,17),(18,1,18),(19,38,19),(20,183,20);
...
INSERT INTO `post_dtl` VALUES (1,1,'사장님이 맛있고 음식이 친절해요',0),(13,13,'Not bad',0),(16,16,'Test content',0),(17,17,'Test contents',0),(18,18,'Image output test',0),(19,19,'Test Data',0),(20,20,'별로...',0);
...
INSERT INTO `post_eval` VALUES (1,1,24,4.5),(13,13,26,3.5),(16,16,26,4),(17,17,1,5),(18,18,1,5),(19,19,38,5),(20,20,183,1.5);
...
INSERT INTO `user_dtl` VALUES (1,1,'테스트계정','','','2023-05-17 08:37:53','2023-05-17 08:37:53'),(2,5,'Test User',NULL,NULL,'2023-05-17 08:53:55','2023-05-17 08:53:55'),(3,8,'Test User #1',NULL,NULL,'2023-05-18 00:11:32','2023-05-18 00:11:32'),(4,9,'Test User #2',NULL,NULL,'2023-05-18 00:32:50','2023-05-18 00:32:50'),(5,10,'김삼겹',NULL,NULL,'2023-05-23 00:36:29','2023-05-23 00:36:29'),(6,11,'김삼겹',NULL,NULL,'2023-05-23 00:46:36','2023-05-23 00:46:36'),(7,12,'dsfds',NULL,NULL,'2023-05-23 00:47:12','2023-05-23 00:47:12'),(8,14,'testuser3',NULL,NULL,'2023-05-23 01:05:18','2023-05-23 01:05:18');
...
INSERT INTO `user_pic` VALUES (8,1,16,8),(9,1,17,9),(10,1,17,10),(11,1,17,11),(12,1,17,12),(13,1,18,13),(14,1,18,14),(15,8,19,15),(16,8,19,16),(17,8,19,17);
...
INSERT INTO `user_post` VALUES (1,1,1),(13,8,13),(16,1,16),(17,1,17),(18,1,18),(19,8,19),(20,9,20);
...
INSERT INTO `user_sub` VALUES (1,9,14,'2023-05-25 06:42:03'),(2,8,14,'2023-05-25 06:42:03'),(3,8,9,'2023-05-25 07:43:47'),(4,9,8,'2023-05-25 07:43:47');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `addCategory`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `addLocation`(
  IN p_loc_name VARCHAR(60),
  IN p_address TEXT,
  IN p_category INT,
...
BEGIN
  INSERT INTO location_mst (loc_name, address, category, latitude, longitude)
  VALUES (p_loc_name, p_address, p_category, p_latitude, p_longitude);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `test_pcd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `test_pcd`(
  IN p_user_id INT
)
BEGIN
...
UPDATE user_dtl SET name = p_name WHERE user_dtl_id = p_user_id AND name != p_name;
END IF;

IF p_introduce IS NOT NULL AND p_introduce != '' THEN
UPDATE user_dtl SET introduce = p_introduce WHERE user_dtl_id = p_user_id AND (introduce != p_introduce OR introduce IS NULL);
END IF;

IF p_image_url IS NOT NULL AND p_image_url != '' THEN
UPDATE user_dtl SET image_url = p_image_url WHERE user_dtl_id = p_user_id AND (image_url != p_image_url OR image_url IS NULL);
END IF;
