...
INSERT INTO `location_eval` VALUES (1,24,1),(3,26,16),(4,1,17),(5,1,18),(7,183,20),(25,307,38);
...
INSERT INTO `location_pic` VALUES (1,26,16,8),(2,1,17,9),(3,1,17,10),(4,1,17,11),(5,1,17,12),(6,1,18,13),(7,1,18,14),(44,307,38,51),(45,307,38,52);
...
INSERT INTO `location_post` VALUES (1,24,1),(16,26,16),(17,1,17),(18,1,18),(20,183,20),(38,307,38);
...
INSERT INTO `post_dtl` VALUES (1,1,'사장님이 맛있고 음식이 친절해요',0),(16,16,'Test content',0),(17,17,'Test contents',0),(18,18,'Image output test',0),(20,20,'별로...',0),(38,38,'수정 테스트 테스트 테스트 ',0);
...
INSERT INTO `post_eval` VALUES (1,1,24,4.5),(16,16,26,4),(17,17,1,5),(18,18,1,5),(20,20,183,1.5),(38,38,307,3);
...
INSERT INTO `user_pic` VALUES (8,1,16,8),(9,1,17,9),(10,1,17,10),(11,1,17,11),(12,1,17,12),(13,1,18,13),(14,1,18,14),(51,8,38,51),(52,8,38,52);
...
INSERT INTO `user_post` VALUES (1,1,1),(16,1,16),(17,1,17),(18,1,18),(20,9,20),(38,8,38);
...
WHERE pm.user_id = p_user_id AND (pd.content != p_post_content OR pd.content IS NULL);
END IF;
...
-- Dump completed on 2023-05-31 18:18:50
